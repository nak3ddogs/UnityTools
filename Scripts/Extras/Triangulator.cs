...
public static class Triangulator
{
	...
	/// <summary>
	/// 3szog halot hoz letre megadott pozicioju nodeokra
	/// </summary>
	/// <param name="XZofVertices">positions</param>
	/// <returns>
	/// csatlakozasok sorrendjet 3assaval. 1es 2eshez, 2es 3ashoz, 3as 1eshez csatlakozik.
	/// </returns>
